...
.tts-play .tts-icon-pause,
.tts-play[data-playing="true"] .tts-icon-play {
  display: none;
}

.tts-play[data-playing="true"] .tts-icon-pause {
  display: inline;
}
